  ...
  return (
    <Page name="welcome">
      <div className="h-[100vh] w-[100vw] p-5 relative">
        ...
        <div className="w-full h-auto p-3 bg-white flex flex-col rounded-lg mb-20">
          <div>
            <h4 className="font-bold text-slate-500">Available Balance</h4>
            <h2 className="text-4xl font-bold text-primary">{`Ghc ${account_balance}`}</h2>
            <div className="w-full h-[1px] bg-slate-400 my-3" />
          </div>
          <div>
            <h4 className="font-bold text-slate-500">Pending Payout</h4>
            <h2 className="text-4xl font-bold text-primary">{`Ghc ${total_pendingpayout}`}</h2>
            <div className="w-full h-[1px] bg-slate-400 my-3" />
          </div>
